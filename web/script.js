...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Datos con formato especificado: curso,nombre,grupo_id,tipo,aula,horas,docente,cupos
    let cursosData = [
        {
            id: 1,
            curso: "1703133",
    ...
    window.editCourse = function(index) {
        ...
        document.getElementById('curso-name').value = curso.curso;
        document.getElementById('grupo-id').value = curso.grupo_id;
        document.getElementById('tipo').value = curso.tipo;
        document.getElementById('aula').value = curso.aula;
        document.getElementById('horas').value = curso.horas;
